...
namespace Screenshots.xUnit
{
    public class UnitTest1
    {
        ...
        //    Assert.Equal("https://api.urlbox.com/v1/MY_API_KEY/75c9016e7f98f90f5eabfd348f3091f7bf625153/png?url=bbc.co.uk",
        //                    output);
        //}
        ...
        public void WithOptions()
        {
            ...
            var output = urlbox.GenerateUrlboxUrl(options);
            Assert.Equal("https://api.urlbox.com/v1/MY_API_KEY/d6b5068716c19ba4556648ad9df047d5847cda0c/png?url=bbc.co.uk&width=1280&thumb_width=500&full_page=true",
                            output);
        }
        [Fact]
        public void WithUrlEncodedOptions()
        {
            ...
            var output = urlbox.GenerateUrlboxUrl(options);
            Assert.Equal("https://api.urlbox.com/v1/MY_API_KEY/9c675714240421b50a9f76892d702cb0a5376ccf/png?url=bbc.co.uk&width=1280&thumb_width=500&full_page=true&user_agent=Mozilla%2F5.0%20%28Windows%20NT%206.1%29%20AppleWebKit%2F537.36%20%28KHTML%2C%20like%20Gecko%29%20Chrome%2F41.0.2228.0%20Safari%2F537.36",
                            output);
        }
        ...
        public void UrlNeedsEncoding()
        {
            ...
            var output = urlbox.GenerateUrlboxUrl(options);
            Assert.Equal("https://api.urlbox.com/v1/MY_API_KEY/4b8ac501f3aaccbea2081a7105302593174ebc23/png?url=https%3A%2F%2Fwww.hatchtank.io%2Fmarkup%2Findex.html%3Furl2png%3Dtrue%26board%3Ddemo_1645_1430",
                            output);
        }
        ...
        public void WithUserAgent()
        {
            ...
            var output = urlbox.GenerateUrlboxUrl(options);
            Assert.Equal("https://api.urlbox.com/v1/MY_API_KEY/c2708392a4d881b4816e61b3ed4d89ae4f2c4a57/png?url=https%3A%2F%2Fbbc.co.uk&user_agent=Mozilla%2F5.0%20%28Macintosh%3B%20Intel%20Mac%20OS%20X%2010_12_6%29%20AppleWebKit%2F537.36%20%28KHTML%2C%20like%20Gecko%29%20Chrome%2F62.0.3202.94%20Safari%2F537.36",
                          output);
        }
        ...
        public void IgnoreEmptyValuesAndFormat()
        {
            ...
            var output = urlbox.GenerateUrlboxUrl(options);
            Assert.Equal("https://api.urlbox.com/v1/MY_API_KEY/ffb3bf33fe1cc481c33f78de7762134662b63dad/png?url=https%3A%2F%2Fbbc.com&full_page=false",
                            output);
        }
        ...
        public void FormatWorks()
        {
            ...
            Assert.Equal("https://api.urlbox.com/v1/MY_API_KEY/75c9016e7f98f90f5eabfd348f3091f7bf625153/jpeg?url=bbc.co.uk",
                          output);
        }
    }
